...
#SBATCH -t 01:00:00 # assign time limit
...
#echo "Starting p25"
#for p25
#bedtools multicov -bams ./sorted.*p25*.bam -bed /uufs/chpc.utah.edu/common/home/karasov-group1/tnseq/data/ref_database/references_sequences/p25_c2/plate25.C2.annotation_no_fasta.gff  > \
#p25c2_counts.gff


#echo "Starting p7"
#for p7
#bedtools multicov -bams ./sorted.*p7*.bam -bed /uufs/chpc.utah.edu/common/home/karasov-group1/tnseq/data/ref_database/references_sequences/p7_g9/annotation/plate7.G9.annotation.gff  > \
#p7g9_counts.gff
#
#
#echo "Starting DC300"
...
#echo "Starting plate"
##for plate
bedtools multicov -bams ./sorted.plate*.bam -bed /uufs/chpc.utah.edu/common/home/karasov-group1/tnseq/data/ref_database/references_sequences/p25_c2/plate25.C2.annotation_no_fasta.gff > \
plaurin_counts.gff
#
