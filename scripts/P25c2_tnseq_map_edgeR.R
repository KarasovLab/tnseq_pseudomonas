...
group_type <- factor(separate(sample_order, sample_order, into = c("tnseq","strain","strain2", "time", "plate","pos"), sep ="_"  )$time)
...
group_batch[which(group_batch == "Tx")] <- "Treated"
...
pdf("tnseq/MDS_p25c2test.pdf", useDingbats = FALSE, fonts = "ArialMT")
...
write.csv(etp$table, "tnseq/edgeR-p25c2.csv")
